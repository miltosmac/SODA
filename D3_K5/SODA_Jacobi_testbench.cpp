...
int main(int argc, char **argv)
{
	...
	temporal(testream_in_0,testream_in_1,testream_in_2,testream_in_3,testream_in_4,testream_out_0,testream_out_1,testream_out_2,testream_out_3,testream_out_4);
	for (int i=0; i<HEIGHT; i++){
		for (int j=0; j<WIDTH; j++){
